  ...
  .then(data => {
    const projects = document.querySelector('div.projects-grid-card');
      ...
      for (const item of data) {
        ...
        const starCount = item.stargazers_count;
        ...
        const folderIconSvg = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        ...
        const starIconSvg = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        const starSpan = document.createElement('span');
        const divBranch = document.createElement('div');
        const svgBranch = document.createElementNS('http://www.w3.org/2000/svg', 'svg');
        const branchIcon1 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        const branchIcon2 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        const branchIcon3 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        const branchIcon4 = document.createElementNS('http://www.w3.org/2000/svg', 'path');
        ...
        starIconSvg.setAttribute('d', 'M10 1.66667L12.575 6.88334L18.3333 7.725L14.1667 11.7833L15.15 17.5167L10 14.8083L4.85001 17.5167L5.83334 11.7833L1.66667 7.725L7.42501 6.88334L10 1.66667Z');
        ...
        branchIcon2.setAttribute('d', 'M15 7.5C16.3807 7.5 17.5 6.38071 17.5 5C17.5 3.61929 16.3807 2.5 15 2.5C13.6193 2.5 12.5 3.61929 12.5 5C12.5 6.38071 13.6193 7.5 15 7.5Z');
        ...
        branchIcon3.setAttribute('d', 'M5 17.5C6.38071 17.5 7.5 16.3807 7.5 15C7.5 13.6193 6.38071 12.5 5 12.5C3.61929 12.5 2.5 13.6193 2.5 15C2.5 16.3807 3.61929 17.5 5 17.5Z');
        ...
        branchIcon4.setAttribute('d', 'M15 7.5C15 9.48912 14.2098 11.3968 12.8033 12.8033C11.3968 14.2098 9.48912 15 7.5 15');
